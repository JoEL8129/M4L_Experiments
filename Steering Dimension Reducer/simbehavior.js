...
function motion(data,eco,options){
    ...
    //print("asd");
    const posDiff = flocc.utils.distance(pos,options.target);

    //maxspeed = maxspeed.multiplyScalar(flocc.utils.clamp(posDiff,0,1));
    ...
    speed = speed.multiplyScalar(flocc.utils.clamp(posDiff*0.05,0.0,1.0));
    local.speed = speed;
